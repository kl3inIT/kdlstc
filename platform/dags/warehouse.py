...
# Full service DNS name: the gateway lives in another namespace, so the bare
# name resolves nowhere. Verified reachable from the workers; still
# overridable for the day it moves.
