...
import vn.dth.mockthu.entity.User;
...
@Component
public class ThuUserMapper extends SynchronizingOidcUserMapper<User> {

    public ThuUserMapper(UnconstrainedDataManager dataManager, UserRepository userRepository, ClaimsRolesMapper claimsRolesMapper, RoleGrantedAuthorityUtils roleGrantedAuthorityUtils) {
